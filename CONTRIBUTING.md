...
5. Build: `dotnet build Akka.Streams.Surgewave.slnx`
6. Test: `dotnet test Akka.Streams.Surgewave.slnx`
...
2. Ensure all tests pass: `dotnet test Akka.Streams.Surgewave.slnx`
3. Ensure zero build warnings: `dotnet build Akka.Streams.Surgewave.slnx -c Release`
...
- Open a [GitHub Issue](https://github.com/Kuestenlogik/Akka.Streams.Surgewave/issues)
